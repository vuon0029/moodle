...
$plugin->version      = 2021063000;         // The current plugin version (Date: YYYYMMDDXX).
$plugin->release      = 'master - Release v1.12 (Build 2021063000) for Moodle 3.9, 3.10 and 3.11';
$plugin->requires     = 2020061507;        // Required Moodle version.
